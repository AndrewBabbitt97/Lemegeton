    ...
    public sealed class State
    {
        ...
        internal class DeferredInvoke
        {
            ...
            private unsafe void InvokeCommand()
            {
                ...
                AtkUnitBase* ptr = (AtkUnitBase*)gg.GetAddonByName("ChatLog", 1).Address;
        ...
        [PluginService] public static ISigScanner ss { get; private set; }
        ...
        [PluginService] public static IGameInteropProvider io { get; private set; }        
