...
namespace Lemegeton.Language
{
    ...
    internal class German : Core.Language
    {
        ...
        public override string LanguageName => "Deutsch";
        ...
        public German(State st) : base(st)
        {
            ...
            AddEntry("Content/Criterion/EwCritAloalo/PlayerMarch/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Criterion/EwCritAloalo/StaticeReload/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Criterion/Enabled", "Aktiviert");
            //AddEntry("Content/Criterion/EwCritAloalo", "Another Aloalo Island");
            AddEntry("Content/Criterion/EwCritAloalo/Enabled", "Aktiviert");
            //AddEntry("Content/Criterion/EwCritAloalo/SpringCrystal", "Spring Crystals safe spot indicator");
            AddEntry("Content/Criterion/EwCritAloalo/SpringCrystal/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Criterion/EwCritAloalo/LalaRotation/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Criterion/EwCritAloalo/PlayerRotation/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Ultimate/UltUcob/FireballAm/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Ultimate/UltUcob/GrandOctetAm/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Ultimate/UltUcob/TenstrikeAm/Enabled", "Aktiviert");
            ...
            AddEntry("Content/EndwalkerRaids/EwRaidAnabaseios/CaloricTheory1AM/Enabled", "Aktiviert");
            ...
            AddEntry("Content/EndwalkerRaids/EwRaidAnabaseios/CaloricTheory2AM/Enabled", "Aktiviert");
            ...
            AddEntry("Content/EndwalkerRaids/EwRaidAnabaseios/PangenesisAM/Enabled", "Aktiviert");
            ...
            AddEntry("Content/EndwalkerRaids/EwRaidAnabaseios/LevinballAM/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Miscellaneous/Overlays/DotTracker/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Debug/Timelines/Enabled", "Aktiviert");
            //AddEntry("Content/Debug/Timelines/TimelineRecorder", "Timeline recorder");
            AddEntry("Content/Debug/Timelines/TimelineRecorder/Enabled", "Aktiviert");
            ...
            AddEntry("Content/Ultimate/UltDragonsongReprise/DothAM/Enabled", "Aktiviert");
            ...
            AddEntry("Status/AllIsWell", "Alles sollte ordnungsgemäß funktionieren!");
            AddEntry("Status/StatusGotOpcodesTrue", "Netzwerk opcodes geladen");
            AddEntry("Status/StatusGotOpcodesFalse", "Konnte Netzwerk opcodes nicht laden!");
            AddEntry("Status/StatusMarkingFuncAvailableTrue", "Markieren Funktion bereit");
            AddEntry("Status/StatusMarkingFuncAvailableFalse", "Konnte Markieren Funktion nicht finden!");
            AddEntry("Status/StatusPostCommandAvailableTrue", "Befehl senden Funktion bereit");
            AddEntry("Status/StatusPostCommandAvailableFalse", "Konnte Befehl senden Funktion nicht finden!");
            AddEntry("Status/StatusNetworkTrafficUpTrue", "Netzwerkverbindung zum Server scheint OK zu sein");
            AddEntry("Status/StatusNetworkTrafficUpFalse", "Keine Netzwerkverbindung zum Server seit über einer Minute!");
            AddEntry("Status/StatusNetworkTrafficDownTrue", "Netzwerkverbindung vom Server scheint OK zu sein");
            AddEntry("Status/StatusNetworkTrafficDownFalse", "Keine Netzwerkverbindung vom Sever seit über einer Minute!");
            AddEntry("Status/WarnNoOpcodes", "Opcodes nicht verfügbar, keine Netzwerkverbindung möglich und deshalb keine Einsicht in's Spiel. Die Funktionalität ist schwer beeinträchtigt!");
            AddEntry("Status/WarnOpcodesVersion", "Opcode Information ist für eine andere Spielversion ({0}) als die momentan geöffnete ({1}) - wahrscheinlich gab es ein Spielupdate und die Opcodes benötigen eine Aktualisierung. Die Funktionalität ist schwer beeinträchtigt!");
            AddEntry("Status/WarnAutomarkersBroken", "Beide Markierungsmethoden sind nicht bereit, kein markieren möglich. Automatisches markieren wird nicht funktionieren!");
            ...
            AddEntry("Status/NumFeaturesAutomarker", "Automatisches markieren");
            AddEntry("Status/NumFeaturesDrawing", "Zeichnungen und Overlay");
            AddEntry("Status/NumFeaturesSound", "Sound Funktionen");
            AddEntry("Status/NumFeaturesHack", "Hacks und Spielergänzungsfunktionen");
            AddEntry("Status/NumFeaturesAutomation", "Automatisierungsfunktionen");
            ...
            AddEntry("ObjectKind/None", "Keine");
            AddEntry("ObjectKind/Player", "Spieler");
            AddEntry("ObjectKind/BattleNpc", "Gegner/Kampf NPC");
            AddEntry("ObjectKind/EventNpc", "Ereignis NPC");
            AddEntry("ObjectKind/Treasure", "Schatztruhe");
            //AddEntry("ObjectKind/Aetheryte", "Aetheryte");
            //AddEntry("ObjectKind/GatheringPoint", "Gathering point");
            AddEntry("ObjectKind/EventObj", "Ereignis Objekt");
            AddEntry("ObjectKind/MountType", "Reittier");
            AddEntry("ObjectKind/Companion", "Begleiter");
            //AddEntry("ObjectKind/Retainer", "Retainer");
            AddEntry("ObjectKind/Area", "Umgebungsobjekt");
            //AddEntry("ObjectKind/Housing", "Housing object");
            AddEntry("ObjectKind/Cutscene", "Zwischensequenzobjekt");
            ...
            AddEntry("Role/Melee", "Nahkampf-Angreifer");
            AddEntry("Role/Ranged", "Phys. Fernkämpfer");
            AddEntry("Role/Caster", "Mag. Fernkämpfer");
            ...
            AddEntry("Automarker/ManualPreset", "Manuell");
            AddEntry("Automarker/PrioType/PartyMember", "Spieler");
            AddEntry("Automarker/PrioType/PartyListOrder", "Gruppenlistenreihenfolge");
            AddEntry("Automarker/PrioType/PartyListCustom", "Benutzerdefinierte Gruppenlistenreihenfolge");
            AddEntry("Automarker/PrioType/Alphabetic", "Alphabetisch");
            AddEntry("Automarker/PrioType/Trinity", "Dreieinigkeit");
            AddEntry("Automarker/PrioType/Role", "Nach Rolle");
            AddEntry("Automarker/PrioType/Job", "Nach Klasse");
            AddEntry("Automarker/PrioType/CongaX", "Westen-Osten Conga-Linie");
            AddEntry("Automarker/PrioType/CongaY", "Norden-Süden Conga-Linie");
            AddEntry("Automarker/PrioType/Player", "Nach Spieler");
            AddEntry("Automarker/PrioType/Player/FillFromPartyList", "Füll von aktueller Gruppe");
            AddEntry("Automarker/PrioType/Player/FillFromCongaLine", "Füll von West-Ost Conga-Linie");
            AddEntry("Automarker/PrioType/PlCustom/FillFromCongaLine", "Füll von West-Ost Conga-Linie");
            AddEntry("Automarker/PrioType/PartyListOrder/Reversed", "Sortiere von Unten-nach-Oben anstatt Oben-nach-Unten");
            AddEntry("Automarker/PrioType/Alphabetic/Reversed", "Sortiere absteigend anstatt aufsteigend");
