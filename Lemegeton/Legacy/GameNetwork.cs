...
internal sealed unsafe class GameNetwork : IGameNetwork
{
    ...
    internal unsafe GameNetwork()
    {
        ...
        this.processZonePacketDownHook = State.io.HookFromAddress<PacketDispatcher.Delegates.OnReceivePacket>(onReceivePacketAddress, this.ProcessZonePacketDownDetour);
        this.processZonePacketUpHook = State.io.HookFromAddress<ProcessZonePacketUpDelegate>(this.address.ProcessZonePacketUp, this.ProcessZonePacketUpDetour);
